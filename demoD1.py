...
def execute():
    ...
    print(f'Q1.1. Acuracia máxima atingida: {_best_accuracy:.2f}% - K = {_best_k}')
    ...
    for i in range(1, _grupoTrain.shape[1] + 1):
        ...
        print(f'Q1.2. Acuracia máxima atingida com {i} caracteristicas: {_best_accuracy:.2f}% - K = {_best_k}')
